...
- MLOps(ML Operations)
  ...
  - **<span style='color:red'>서비스 패키징</span>**은 컨테이너 이미지 제작 기술(가상화 기술)을 카리키는 용어입니다. 여기서 컨테이너 기술이 등장하는데요, **컨테이너 기술**     은 <span style='color:red'>모델 학습 환경과 실제 서비스되는 예측 환경을 동일하게 맞추기 위해</span>필요하다고 할 수 있습니다. 
